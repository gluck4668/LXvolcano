...
#----- Gene volcano function----------------
  ...
  meta_volcano <- function(data_file) {
    ...
    meat_all_file <- paste("analysis result/Metabolite volcano data (P0.05, unlimited FC)_all",group_names,".xlsx")

    write.xlsx(meta_df,meat_all_file)
    ...
    meat_all_dif_file <- paste("analysis result/Metabolite volcano data (P0.05, unlimited FC)_diferent",group_names,".xlsx")

    write.xlsx(meta_dd,meat_all_dif_file)

    meta_p1 <- paste("analysis result/Metabolite Volcano graphics 01 (P0.05, unlimited FC)",group_names,".png")
    meta_p2 <- paste("analysis result/Metabolite Volcano graphics 02 (P0.05, unlimited FC)",group_names,".png")
    meta_p3 <- paste("analysis result/Metabolite Volcano graphics 03 (P0.05, unlimited FC)",group_names,".png")
    meta_p4 <- paste("analysis result/Metabolite Volcano graphics 04 (P0.05, unlimited FC)",group_names,".png")

    ggsave(meta_p1,p01, width=1200, height =1000, dpi=180,units = "px")
    ggsave(meta_p2,p02, width=1200, height =1000, dpi=180,units = "px")
    ggsave(meta_p3,p03, width=1400, height =1000, dpi=180,units = "px")
    ggsave(meta_p4,p04, width=1400, height =1000, dpi=180,units = "px")} else
    {meta_df <- data[,c(1:5)]
    meta_df <- meta_df[order(meta_df[,5]),]

    meat_all_FC2_file <- paste("analysis result/Metabolite volcano data (P0.05, FC2)_all",group_names,".xlsx")
    write.xlsx(meta_df,meat_all_FC2_file)
    ...
    rm(i)
    meta_dd <- na.omit(meta_dd)
    meat_dif_FC2_file <- paste("analysis result/Metabolite volcano data (P0.05, FC2)_diferent",group_names,".xlsx")
    write.xlsx(meta_dd, meat_dif_FC2_file)

    meta_FC2_p1 <- paste("analysis result/Metabolite Volcano graphics 01 (P0.05, FC2)",group_names,".png")
    meta_FC2_p2 <- paste("analysis result/Metabolite Volcano graphics 02 (P0.05, FC2)",group_names,".png")
    meta_FC2_p3 <- paste("analysis result/Metabolite Volcano graphics 03 (P0.05, FC2)",group_names,".png")
    meta_FC2_p4 <- paste("analysis result/Metabolite Volcano graphics 04 (P0.05, FC2)",group_names,".png")


    ggsave(meta_FC2_p1,p01, width=1200, height =1000, dpi=180,units = "px")
    ggsave(meta_FC2_p2,p02, width=1200, height =1000, dpi=180,units = "px")
    ggsave(meta_FC2_p3,p03, width=1400, height =1000, dpi=180,units = "px")
    ggsave(meta_FC2_p4,p04, width=1400, height =1000, dpi=180,units = "px")}
  ...
  if(is.null(Meta_FC)==TRUE)
  {if(file.exists(gene_p1)==TRUE)
  {plot_png <- readPNG(gene_p1)
  r <- nrow(plot_png)/ncol(plot_png)
  plot(c(0,1),c(0,r),type="n",xlab="",ylab="",asp=1)
  rasterImage(plot_png,0,0,1,r)}} else
  {if(file.exists(gene_FC2_p1)==TRUE)
  {plot_png <- readPNG(gene_FC2_p1)
  r <- nrow(plot_png)/ncol(plot_png)
  plot(c(0,1),c(0,r),type="n",xlab="",ylab="",asp=1)
  ...
  if(is.null(Meta_FC)==TRUE)
  {if(file.exists(meta_p1)==TRUE)
  {plot_png <- readPNG(meta_p1)
  r <- nrow(plot_png)/ncol(plot_png)
  plot(c(0,1),c(0,r),type="n",xlab="",ylab="",asp=1)
  rasterImage(plot_png,0,0,1,r)}} else
  {if(file.exists(meta_FC2_p1)==TRUE)
  {plot_png <- readPNG(meta_FC2_p1)
  r <- nrow(plot_png)/ncol(plot_png)
  plot(c(0,1),c(0,r),type="n",xlab="",ylab="",asp=1)
  rasterImage(plot_png,0,0,1,r)}}
